...
function databus.PA()
    databus.ps.toggle('PA')
end
function databus.ap_dc()
    databus.ps.publish('ARM_AP',false)
    databus.ps.publish('ARM_AT',false)
end
function databus.bomb()
    databus.ps.toggle('Bomb')
end

function databus.nuke(v)
    databus.ps.publish('nlcd',v)

    
end
function databus.revrsr()
    databus.ps.toggle('Trevrsr')
end
function databus.engn()
    databus.ps.toggle('engn')
end
function databus.sweep()
    databus.ps.toggle('sweep')
end
...
function databus.gear() databus.ps.toggle('tgl_gear') end
